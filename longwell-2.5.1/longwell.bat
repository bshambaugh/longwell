...
set MAVEN_OPTS=-Djava.awt.headless=true -Dslf4j=false -Dlog4j.configuration=file:./src/main/webapp/WEB-INF/log4j.properties -Djava.security.auth.login.config=file:./src/main/resources/jaas.config
set ACTION=run
